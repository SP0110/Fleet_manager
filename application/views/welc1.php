...
<body>
  ...
  <div class="collapse navbar-collapse justify-content-end id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <?php    echo '<label><a class="nav-link text-white"  href="'.base_url().'index.php/Log/profiles">Vehicles</a></label>';?>
      </li>
      <li class="nav-item">
        <?php    echo '<label><a class="nav-link text-white"  href="'.base_url().'index.php/Log2/stud_db">Students</a></label>';?>
      </li>
      <li class="nav-item active">
        <?php    echo '<label><a class="nav-link text-white"  href="'.base_url().'index.php/Log/fuelprofile">Fuel</a></label>';?>
      </li>
      <li class="nav-item">
