...
<div class="row">
  ...
  <div class="col-md-4 offset-md-4 display-4" value="search"><button formaction="<?php echo base_url(); ?>index.php/Log2/stud_index" name="search" class="btn btn-info">search</button>
  <button class="btn btn-info" formaction="<?php echo base_url(); ?>index.php/Log2/addstud" name="add" value="add">Add</button></div>
