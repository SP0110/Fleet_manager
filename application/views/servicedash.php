...
&nbsp&nbsp&nbsp&nbsp&nbsp
  ...
  <form> &nbsp
      <button formaction="<?php echo base_url(); ?>index.php/Log/" class="btn btn-info">Service History</button><br><br> &nbsp
      <button formaction="<?php echo base_url(); ?>index.php/Log/" class="btn btn-info">Work Orders</button><br><br> &nbsp
